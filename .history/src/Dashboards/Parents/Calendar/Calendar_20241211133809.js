...
export default function Event({ localizer = mLocalizer, ...props }) {
  ...
  const eventStyleGetter = (event) => {
    ...
    if (event.title === "Open Day") borderRight = "solid 2px red";
    else if (event.title === "Picture Day") borderRight = "solid 2px green";
    else if (event.title === "Heritage Day") borderRight = "solid 2px purple";

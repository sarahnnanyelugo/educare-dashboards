...
export default function Event({ localizer = mLocalizer, ...props }) {
  ...
  const eventStyleGetter = (event) => {
    let borderRight = "#fff"; // Default blue

    if (event.title === "Open Day") borderLeft = "solid 2px red";
    else if (event.title === "Picture Day") borderLeft = "solid 2px green";
    else if (event.title === "Heritage Day") borderLeft = "solid 2px purple";

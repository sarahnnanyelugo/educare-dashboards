...
export default function EventCalendar({ localizer = mLocalizer, ...props }) {
  const [events] = useState([
    { title: "Election Day", start: new Date(2024, 8, 2), end: new Date(2024, 8, 2), allDay: true },
    { title: "Cultural Day", start: new Date(2024, 8, 4), end: new Date(2024, 8, 4), allDay: true },
    { title: "Open Day", start: new Date(2024, 8, 22), end: new Date(2024, 8, 22), allDay: true },
    { title: "Picture Day", start: new Date(2024, 8, 22), end: new Date(2024, 8, 22), allDay: true },
    { title: "Heritage Day", start: new Date(2024, 8, 26), end: new Date(2024, 8, 26), allDay: true },
  ]);
  ...
  return (
    <div className="calendar-container" style={{ height: "calc(100vh - 100px)" }}>
      <Calendar

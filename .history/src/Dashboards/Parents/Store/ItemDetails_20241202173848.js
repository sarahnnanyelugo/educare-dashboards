      ...
      <div className="modal-overlay ">
        <div className="modal-content d-md-flex">
          ...
          <div className="col-md-6 details">
            ...
            <div className="info">
              <p>
                Please ensure you select the right size. If you are unsure,
                kindly schedule a sizing appointment Here Items bought in good
                condition cannot be returned or changed due to wrong size.
              </p>
            </div>
          </div>
        </div>

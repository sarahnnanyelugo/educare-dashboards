      ...
      <Desktop>
        ...
        <div className="my-children-view">
          ...
          <div className="d-md-flex">
            ...
            <div style={{ paddingRight: "5px" }} className="col-md-4">
              <div className="col-md-12 card attendance-summary">
                {" "}
        ...
        <div className="my-children-view">
          ...
          <div className="d-md-flex">
            <div className="col-md-8 ">
              ...
              <div className="col-12card attendance-summary">
                <h6>Attendance Summary</h6>
                <div className="attendance missed d-flex">
                  <img src={Icon} width="34px" height="34px" />
                  <p>2 days missed</p>
              ...
              <h6 className="mt-5">Documents</h6>
              <div className="card file-input">
                <Documents />
              </div>
            </div>

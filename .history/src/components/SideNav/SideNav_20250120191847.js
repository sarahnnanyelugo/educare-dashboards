        ...
        >
          <div className="nav-inner">
            ...
            <button
              ...
              style={{
                marginLeft: isCollapsed ? "30px" : "90px",
                background: "#fff",
                ...
                >
                  {item.accordion ? (
                    <Accordion
                      defaultActiveKey=""
                      style={{
                        width: isCollapsed ? "50px" : "100%", // Collapse width with sidebar
                        transition: "width 0.3s ease",
                        overflow: "hidden",
                      }}
                    >
                            ...
                            {item.accordionContent.map((contentItem, idx) => (
                              ...
                              >
                                <NavLink
                                  ...
                                  style={{
                                    pointerEvents: isCollapsed
                                      ? "none"
                                      : "auto", // Disable navigation
                                    opacity: isCollapsed ? 0.5 : 1, // Reduce visibility
                                  }}
                                >
                                  {contentItem.name}
                                </NavLink>
